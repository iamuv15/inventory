...
$(document).ready(function(){
 ...
 //    });
    ...
    // Add smooth scrolling to Menu links
         $(".main-menu li a, .smooth, .banner-content a, .footer-nav li a").on('click', function(event) {
                if (this.hash !== "") {
...
$('.why button').on('click', function(){
	$(this).hide();
	$('.why li').css("display", "block");
});

$('#student_company').on('click', function(){
	$('#student').hide();
	$('#company').show();
});

$('#company_student').on('click', function(){
	$('#student').show();
	$('#company').hide();
});
