...
<div class="container">
	<div class="row">
        ...
        <div class="table-responsive">
          <a href="{{ route('addInvoice') }}" name="add_new" class="btn btn-primary" data-title="Add" data-target="#add">Create Proforma Invoice</a><br><br>
          <table id="mytable" class="table table-bordred table-striped">
            <thead>
             <tr>
               <th>Reference Number</th>
               <th>Consignee</th>
               <th>Reference Date Date</th>
               <th>Action</th>
               <th>Action</th>
               <th>Action</th>
             </tr>
            ...
            <tbody>
				@foreach($items->unique('batch') as $item)
                    ...
                    <td>{{ $item->reference_number }}</td>
  	                ...
  	                <td><p data-placement="top" data-toggle="tooltip" title="Edit"><a href="{{ asset('invoice') }}/edit/{{ $item->batch }}" class="btn btn-primary btn-xs" data-title="Edit">Edit</a></p></td>
  	                <td><p data-placement="top" data-toggle="tooltip" title="Print"><a href="{{ asset('invoice') }}/club/{{ $item->batch }}" class="btn btn-primary btn-xs" data-title="Print">Print</a></p></td>
  	                <td><p data-placement="top" data-toggle="tooltip" title="Delete"><a href="{{ asset('invoice') }}/delete/{{ $item->batch }}" class="btn btn-danger btn-xs" data-title="Delete">Delete</a></p></td>
  	              </tr>
				@endforeach
            </tbody>
          </table>
